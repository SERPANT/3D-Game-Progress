function Game(canv) {
  ...
  var scoreTriangleImage = new Image();
  scoreTriangleImage.src = "images/pyramid.png";
  ...
  // var colorType = ["gray", "red", "blue", "purple", "brown", "#333366"];
  var colorType = [
    "brown",
    "#ff3333",
    "#ff6633",
  ...
  function drawScore() {
    ...
    ctx.drawImage(scoreTriangleImage, 10, 10, 80, 80);
  ...
  function makeEnemy(detail) {
    var enemy = new Enemy();
    enemy.init(detail, enemySpeed[getRandom(0, 5)]);
    objects.push(enemy);
  }
