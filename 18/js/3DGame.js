function Game(canv) {
  ...
  var colorType = ["gray", "gold", "blue", "purple", "brown", "indigo"];
  var v = 10;
  ...
  function checkIntersection(object, camFuturePosition) {
    // console.log("cam", camFuturePosition);
    // console.log("topleftfront", object.topLeftFront);
    // console.log("toprightfront", object.topRightFront);
    // console.log("bottomrightfront", object.bottomRightFront);
    // console.log("bottomleftFront", object.bottomLeftFront);
    // console.log("bottomleftback", object.bottomLeftBack);
    //let playerBody = [camFuturePosition[0] - 10,camFuturePosition[0]+10];
    let extend = 100;
    let extendSide = 30;

    if (
      camFuturePosition[0] >= object.topLeftFront[0] - extendSide &&
      camFuturePosition[0] <= object.topRightFront[0] + extendSide &&
      camFuturePosition[1] >= object.topLeftFront[1] - extend &&
      camFuturePosition[1] <= object.bottomLeftFront[1] + extend &&
      camFuturePosition[2] >= object.bottomLeftFront[2] - extend &&
      camFuturePosition[2] <= object.bottomLeftBack[2] + extend
    ) {
  ...
  function drawObjects() {
    for (ob of objects) {
      ...
      for (var cubeObject of cubes) {
        ...
        drawCube(facesList, cubeObject.color, cubeObject.Type, direction);
      }
    }
  }
  ...
  function move(event) {
    ...
    cam.keydownUpdate("Key" + event.key.toUpperCase());
  }
